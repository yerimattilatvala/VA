...
frame = cv2.imread("4.Eyes_and_gaze\Derecha1.jpg")
img = frame
#downsample
...
for (x,y,w,h) in detected:
	...
	pupilO = pupilFrame
	#_, pupilFrame = cv2.threshold(pupilFrame,55,255,cv2.THRESH_BINARY)		#50 ..nothin 70 is better
	pupilFrame =cv2.adaptiveThreshold(pupilFrame,255,cv2.ADAPTIVE_THRESH_MEAN_C,\
