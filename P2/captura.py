...
while 1:
    ...
    for (x,y,w,h) in faces:
        ...
        for (ex,ey,ew,eh) in eyes:
            cv2.rectangle(face_color,(ex,ey),(ex+ew,ey+eh),(0,255,0),2) #para marcar los ojos en la imagen en color
            eye = face_color[ey:ey+eh,ex:ex+ew]#aqui seleccionamos el contorno de cada ojo
