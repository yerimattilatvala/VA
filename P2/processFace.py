...
#SELECCIONAMOS ZONA DE LOS OJOS
ojoDerecho = roi1[:,:part]
ojoIzquierdo = roi1[:,2*part:]
lookSide = []
#BUSCAMOS LA PUPILA USANDO LA FUNCION hougN
...
lookSide = L1 + L2
if (d1+d1)>(i1+i2):             #SE CALCULA EN QUE LADO DE LA PUPILA HAY MAYOR 
    lookSide.append('Left')     #PORCENTAJE DE PIXELES BLANCOS
else:
